...
#define CC1101_DEFVAL_IOCFG2           0x29 //Clear channel assessment. High when RSSI level is below threshold
#define CC1101_DEFVAL_IOCFG1           0x2E // Set high (1) or low (0) output drive strength on the GDO pins
#define CC1101_DEFVAL_IOCFG0           0x06 //Asserts when sync word has been sent / received, and de-asserts at the end of the packet
#define CC1101_DEFVAL_FIFOTHR          0x47
#define CC1101_DEFVAL_SYNC1            0xD3
#define CC1101_DEFVAL_SYNC0            0x91
#define CC1101_DEFVAL_PKTLEN           0xFF
