...
//====================PORTL=======================
#define MDM_PWR_RDY_PORT      PORTL
#define MDM_PWR_RDY_DDR       DDRL
#define MDM_PWR_RDY_PORTIN    PINL
#define MDM_PWR_RDY_PIN       0

#define SIMPRES_CTRL_PORT     PORTL
#define SIMPRES_CTRL_DDR      DDRL
#define SIMPRES_CTRL_PORTIN   PIN
#define SIMPRES_CTRL_PIN      1

#define MDM_PWR_KEY_PORT      PORTL
#define MDM_PWR_KEY_DDR       DDRL
#define MDM_PWR_KEY_PORTIN    PINL
#define MDM_PWR_KEY_PIN       2

#define SIMSEL_CTRL_PORT     PORTL
#define SIMSEL_CTRL_DDR      DDRL
#define SIMSEL_CTRL_PORTIN   PIN
#define SIMSEL_CTRL_PIN      3
